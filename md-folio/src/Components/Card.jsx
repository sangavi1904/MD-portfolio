                                ...
                                <div class="content" style={{ padding: "18px" }}>
                                    <div class="category-info">
                                        ...
                                        <div class="category-list">
                                            <a href="https://venkatesanj.com/projects-cat/project/" className='anchor'>project</a>
                                        </div>

                                    </div>
                                    <h4 class="title">
                                        <a href="https://venkatesanj.com/projects/signet-jewelers/" data-url="" data-toggle="modal">IDFC First Bank
                        ...
                        <div class="card custom-card p-5" >
                            <a href="/">
                                ...
                                <div class="content" style={{ padding: "18px" }}>
                                    ...
                                    <h4 class="title">
                                        <a href="https://venkatesanj.com/projects/signet-jewelers/" data-url="" data-toggle="modal">Signet Jewelers
                                            <i class="feather-arrow-up-right"></i></a>
                                    </h4>
                                </div>
                            </div>
                        ...
                        <div class="card custom-card p-5" >
                            <a href="/">
                                ...
                                <div class="content" style={{ padding: "18px" }}>
                                    ...
                                    <h4 class="title">
                                        <a href="https://venkatesanj.com/projects/signet-jewelers/" data-url="" data-toggle="modal">Trading 212
                                            <i class="feather-arrow-up-right"></i></a>
                                    </h4>
                                </div>
                            </div>
                        ...
                        <div class="card custom-card p-5">
                            <a href="/">
                                ...
                                <div class="content" style={{ padding: "18px" }}>
                                    ...
                                    <h4 class="title">
                                        <a href="https://venkatesanj.com/projects/signet-jewelers/" data-url="" data-toggle="modal">Small Billing and CRM Sytem
                                            <i class="feather-arrow-up-right"></i></a>
                                    </h4>
                                </div>
                            </div>
                        ...
                        <div class="card custom-card p-5">
                            <a href="/">
                                ...
                                <div class="content" style={{ padding: "18px" }}>
                                    ...
                                    <h4 class="title">
                                        <a href="https://venkatesanj.com/projects/signet-jewelers/" data-url="" data-toggle="modal">Transaction Managment System
                                            <i class="feather-arrow-up-right"></i></a>
                                    </h4>
                                </div>
                            </div>
